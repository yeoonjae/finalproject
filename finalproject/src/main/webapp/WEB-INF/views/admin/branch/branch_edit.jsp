	...
	<div class="container-fluid">
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						<th scope="row">지역</th>
						<td><input type="hidden" name="local_no" value="${branchDto.local_no}" readonly>${branchDto.local_name}</td>
					</tr>
					<tr>
					...
					<tr>
						<th>주소</th>
						<td><input type="number" class="form-control" id="branchPost" name="branch_post" value="${branchDto.branch_post}" required style="display: inline; width: 170px; float: left;" readonly>
							<input class="form-control" type="text" name="branch_basic_addr" value="${branchDto.branch_basic_addr}" required readonly>
							<input class="form-control" type="text" name="branch_detail_addr" value="${branchDto.branch_detail_addr}" required readonly>			
						</td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row">평수</th>
						<td><input class="form-control" type="text" name="branch_size" value="${branchDto.branch_size}" readonly="readonly"></td>
					</tr>
					<tr>
