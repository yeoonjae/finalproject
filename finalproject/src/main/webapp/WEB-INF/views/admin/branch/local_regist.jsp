		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">지점등록 ( 한글 2글자로 등록해주세요.
						ex)경기,충남,서울 )</li>
				</ol>
						...
						<div class="list breadcrumb">
							...
							<c:forEach var="localDto" items="${list}">
							  <li class="nav-item dropdown">
						        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">${localDto.local_name}</a>
						        <div class="dropdown-menu" style="">
<!-- 						          <a class="dropdown-item delete" onclick="if(!confirm('삭제하시겠습니까?')){return false;}">삭제</a> -->
						          <a class="dropdown-item delete">삭제</a>
						          <input class="no" type="hidden" value="${localDto.local_no}">
						         </div>
						       </li>
							</c:forEach>
