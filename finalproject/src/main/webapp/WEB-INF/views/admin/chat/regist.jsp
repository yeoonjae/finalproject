...
<script
	src="${pageContext.request.contextPath}/resources/assets/js/lightpick.js"></script>
<script
...
<%-- 									<td><a href="edit?point_no=${chatDto.point_no}"> --%>
<!-- 											<button class="btn btn-primary">수정</button> -->
<%-- 									</a> <a class="link" href="delete/${pointDto.point_no}"> --%>
