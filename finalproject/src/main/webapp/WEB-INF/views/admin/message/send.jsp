                     ...
                     <form action="send" method="post">
                        <fieldset>
                           <div class="form-group">
                              ...
                              <!-- 발신인 -->
                              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly value="${admininfo.admin_name}">
                              <input type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="${admininfo.admin_no}" name="sender_no">
                           </div>
                           <div class="form-group">
