...
<div id="content-wrapper">
	<div class="container-fluid">
		...
		<div class="container-form offset-sm-3 col-sm-6 offset-md-3 col-md-6">
			<form action="${pageContext.request.contextPath}/member/account/cert_email" method="post"
				onsubmit="return checkCert();">
				<div class="form-group">
					...
					<input type="text" class="form-control insecret" id="secret" name="secret" maxlength="6"
						onblur="cert();">
